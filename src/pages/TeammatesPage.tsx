...
import {
    ...
    Users, Github, Linkedin, Globe, Send, UserCheck,
    Filter, RefreshCw, GraduationCap, Radio, List,
} from 'lucide-react';
...
function StyleInject() {
    useEffect(() => {
        ...
        el.id = 'tf-style'; el.textContent = CSS;
...
const MOCK: Teammate[] = [
    {
        id: 1, name: 'Priya Sharma', branch: 'CSE', year: 3,
        gender: 'female',
        ...
        available: true, github: 'priyasharma', linkedin: 'priya-sharma',
        hackathons: 6, projects: 4,
    },
    {
        id: 2, name: 'Arjun Mehta', branch: 'IT', year: 3,
        gender: 'male',
        ...
        available: true, github: 'arjunml',
        hackathons: 4, projects: 6,
    },
    {
        id: 3, name: 'Sneha Gupta', branch: 'CSE', year: 2,
        gender: 'female',
        ...
        available: true, github: 'sneha-dev', linkedin: 'sneha-gupta-dev',
        hackathons: 3, projects: 5,
    },
    {
        id: 4, name: 'Rohan Verma', branch: 'ECE', year: 4,
        gender: 'male',
        ...
        available: false,
        hackathons: 5, projects: 3,
    },
    {
        id: 5, name: 'Aisha Khan', branch: 'CSE', year: 1,
        gender: 'female',
        ...
        available: true, github: 'aisha-dev',
        hackathons: 1, projects: 2,
    },
    {
        id: 6, name: 'Vikram Singh', branch: 'IT', year: 4,
        gender: 'male',
        ...
        available: false, linkedin: 'vikram-singh-dev',
        hackathons: 3, projects: 7,
    },
    {
        id: 7, name: 'Nandini Joshi', branch: 'CSE', year: 3,
        gender: 'female',
        ...
        available: true, github: 'nandini-ds', linkedin: 'nandini-joshi',
        hackathons: 2, projects: 4,
    },
    {
        id: 8, name: 'Dev Patel', branch: 'ME', year: 2,
        gender: 'male',
        ...
        available: true,
        hackathons: 2, projects: 3,
    },
    {
        id: 9, name: 'Ritika Agarwal', branch: 'CSE', year: 4,
        gender: 'female',
        ...
        available: true, github: 'ritika-dev', linkedin: 'ritika-agarwal',
        hackathons: 8, projects: 9,
    },
    {
        id: 10, name: 'Kabir Malhotra', branch: 'IT', year: 2,
        gender: 'male',
        ...
        available: true, github: 'kabir-sec',
        hackathons: 3, projects: 2,
    },
    {
        id: 11, name: 'Pooja Rao', branch: 'ECE', year: 3,
        gender: 'female',
        ...
        available: false, linkedin: 'pooja-rao-vlsi',
        hackathons: 1, projects: 4,
    },
    {
        id: 12, name: 'Ansh Saxena', branch: 'CSE', year: 1,
        gender: 'male',
        ...
        available: true, github: 'ansh-cp',
        hackathons: 2, projects: 1,
    },
];
...
const DEFAULT_FILTERS: Filters = {
    search: '', skills: [], branch: 'All',
    year: 'All', gender: 'All', availableOnly: false,
};
...
function SkillTag({ label, highlight = false }: { label: string; highlight?: boolean }) {
    return (
        <span style={{
            ...
            fontSize: '0.72rem', fontWeight: 600, fontFamily: FONT,
            whiteSpace: 'nowrap',
        }}>{label}</span>
    );
}
...
function SkillMultiSelect({
    ...
    return (
        <div ref={ref} style={{ position: 'relative' }}>
            ...
            >
                <span style={{ fontSize: '0.83rem', color: selected.length ? B.dark : B.muted, fontFamily: FONT }}>
                    {selected.length === 0
                        ? 'Any skill'
                        : selected.length === 1
                            ? selected[0]
                ...
                <ChevronDown size={15} style={{ color: B.muted, transform: open ? 'rotate(180deg)' : 'none', transition: 'transform 0.2s', flexShrink: 0 }} />
            </div>
            ...
            {open && (
                <div style={{
                    ...
                    borderRadius: '0.85rem', zIndex: 30,
                    boxShadow: '0 8px 28px rgba(40,41,44,0.12)',
                    overflow: 'hidden',
                }}>
                    <div style={{ padding: '0.6rem', borderBottom: `1px solid ${B.border}` }}>
                        <div style={{
                            display: 'flex', alignItems: 'center', gap: '0.5rem',
                            background: 'rgba(40,41,44,0.04)', borderRadius: '0.6rem',
                            ...
                            <input
                                ...
                                style={{
                                    ...
                                    fontSize: '0.8rem', color: B.dark, fontFamily: FONT, width: '100%',
                                }}
                            />
                        </div>
                    </div>
                    <div style={{ maxHeight: 210, overflowY: 'auto' }} className="tf-filter-scroll">
                        {filtered.map(s => {
                            ...
                            return (
                                ...
                                >
                                    <span style={{ fontSize: '0.83rem', color: B.dark, fontFamily: FONT }}>{s}</span>
                                    <div style={{
                                        width: 18, height: 18, borderRadius: '0.35rem',
                        ...
                        {filtered.length === 0 && (
                            <p style={{ padding: '1rem', fontSize: '0.8rem', color: B.muted, fontFamily: FONT, textAlign: 'center' }}>
                                No skills match
                            </p>
                        )}
                    </div>
        ...
        <div style={{ position: 'relative' }}>
            <select
                ...
                style={{
                    ...
                    borderRadius: '0.75rem', appearance: 'none',
                    padding: '0.6rem 2.2rem 0.6rem 0.85rem',
                    fontSize: '0.83rem', color: value === 'All' ? B.muted : B.dark,
...
function AvailToggle({ value, onChange }: { value: boolean; onChange: (v: boolean) => void }) {
    return (
        ...
        >
            <span style={{ fontSize: '0.83rem', color: B.dark, fontFamily: FONT }}>Available only</span>
            <div style={{
...
function FilterPanel({ filters, onChange, resultCount, totalCount }: FilterPanelProps) {
    ...
    return (
        <div style={{
                ...
                {isActive && (
                    <button
                        ...
                        style={{
                            ...
                            color: B.muted, fontSize: '0.75rem', fontFamily: FONT, fontWeight: 600,
            ...
            <div style={{
                ...
                background: B.active, marginBottom: '1.5rem',
                display: 'flex', alignItems: 'center', justifyContent: 'space-between',
            }}>
                <span style={{ fontSize: '0.75rem', color: B.muted, fontFamily: FONT }}>Showing</span>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.4rem' }}>
                ...
                <div>
                    ...
                    <SkillMultiSelect selected={filters.skills} onChange={set('skills')} />
                </div>

                {/* Gender */}
                <div>
                    <p style={labelStyle}>Gender</p>
                    <FilterSelect value={filters.gender} onChange={set('gender')} options={GENDERS} label="Gender" />
                </div>

                {/* Branch */}
                <div>
                    <p style={labelStyle}>Branch</p>
                    <FilterSelect value={filters.branch} onChange={set('branch')} options={BRANCHES} label="Branch" />
                </div>

                {/* Year */}
                <div>
                    <p style={labelStyle}>Year</p>
                    <FilterSelect value={filters.year} onChange={set('year')} options={YEARS} label="Year" />
                </div>

                {/* Availability */}
                <div style={{ paddingTop: '0.5rem', borderTop: `1px solid ${B.border}` }}>
                    <AvailToggle value={filters.availableOnly} onChange={set('availableOnly')} />
                </div>
            </div>
        </div>
    );
...
const labelStyle: React.CSSProperties = {
    ...
    fontFamily: FONT, marginBottom: '0.45rem',
};

/* ═══════════════════════════════════════════════════
   TEAMMATE CARD
═══════════════════════════════════════════════════ */
interface CardProps { mate: Teammate; selectedSkills: string[]; delay: number; }
function TeammateCard({ mate, selectedSkills, delay }: CardProps) {
    const [invited, setInvited] = useState(false);
    const [loading, setLoading] = useState(false);
    const yearLabel = ['', '1st', '2nd', '3rd', '4th'][mate.year] ?? `${mate.year}th`;
    ...
    return (
        <div
            ...
            style={{
                ...
                boxShadow: B.shadow, padding: '1.4rem 1.5rem',
        ...
        >
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.9rem' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
                        <h3 style={{
                            fontSize: '0.97rem', fontWeight: 800, color: B.dark,
                        ...
                        <span style={{
                            ...
                            boxShadow: mate.available ? `0 0 0 2px rgba(56,161,105,0.18)` : 'none',
                            display: 'inline-block',
                        }} />
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginTop: '0.15rem', flexWrap: 'wrap' }}>
                        <span style={{ fontSize: '0.75rem', color: B.muted, fontFamily: FONT, display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
            ...
            <div style={{
                ...
                paddingTop: '0.75rem', borderTop: `1px solid ${B.border}`,
            }}>
                <div style={{ textAlign: 'center' }}>
                    <p style={{ fontSize: '1rem', fontWeight: 900, color: B.dark, fontFamily: FONT, letterSpacing: '-0.04em' }}>
                        {mate.hackathons}
                    </p>
                    <p style={{ fontSize: '0.68rem', color: B.muted, fontFamily: FONT, marginTop: '1px' }}>Hackathons</p>
                </div>
                <div style={{ textAlign: 'center' }}>
                    <p style={{ fontSize: '1rem', fontWeight: 900, color: B.dark, fontFamily: FONT, letterSpacing: '-0.04em' }}>
                        {mate.projects}
                    </p>
                    <p style={{ fontSize: '0.68rem', color: B.muted, fontFamily: FONT, marginTop: '1px' }}>Projects</p>
                </div>
                <div style={{ flex: 1 }} />
                {/* Social icons */}
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                    {mate.github && (
                        <a href={`https://github.com/${mate.github}`} target="_blank" rel="noreferrer"
                            style={{ color: B.muted, display: 'flex', transition: 'color 0.15s' }}
                            onMouseEnter={e => (e.currentTarget.style.color = B.dark)}
                            onMouseLeave={e => (e.currentTarget.style.color = B.muted)}>
                            <Github size={15} />
                        </a>
                    ...
                    {mate.linkedin && (
                        <a href={`https://linkedin.com/in/${mate.linkedin}`} target="_blank" rel="noreferrer"
                            style={{ color: B.muted, display: 'flex', transition: 'color 0.15s' }}
                            onMouseEnter={e => (e.currentTarget.style.color = B.dark)}
                            onMouseLeave={e => (e.currentTarget.style.color = B.muted)}>
                            <Linkedin size={15} />
                    ...
                    {mate.website && (
                        <a href={mate.website} target="_blank" rel="noreferrer"
                            style={{ color: B.muted, display: 'flex', transition: 'color 0.15s' }}
                            onMouseEnter={e => (e.currentTarget.style.color = B.dark)}
                            onMouseLeave={e => (e.currentTarget.style.color = B.muted)}>
                            <Globe size={15} />
            ...
            <button
                ...
                style={{
                    ...
                    borderRadius: '999px', border: 'none', cursor: invited ? 'default' : 'pointer',
                ...
                {loading ? (
                    <>
                        <span style={{
                            ...
                            animation: 'tfSpin 0.75s linear infinite', display: 'inline-block',
                        }} />
                        Sending…
                    </>
                ) : invited ? (
...
function EmptyState({ onReset }: { onReset: () => void }) {
    return (
        <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
                <p style={{ fontSize: '1rem', fontWeight: 800, color: B.dark, fontFamily: FONT, letterSpacing: '-0.02em' }}>
                    No teammates found
                </p>
                <p style={{ fontSize: '0.83rem', color: B.muted, fontFamily: FONT, marginTop: '0.35rem' }}>
            ...
            <button
                onClick={onReset}
                style={{
                    marginTop: '0.25rem', padding: '0.6rem 1.5rem',
                    borderRadius: '999px', border: `1.5px solid ${B.dark}`,
                ...
                onMouseLeave={e => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = B.dark; }}
            >
                Reset Filters
            </button>
        </div>
...
/* ═══════════════════════════════════════════════════
   MAIN PAGE EXPORT
═══════════════════════════════════════════════════ */
export interface TeammatesPageUser { id: string; name: string; email: string; avatar?: string; }
...
export default function TeammatesPage({ user }: { user: TeammatesPageUser }) {
    ...
    const results = useMemo(() => {
        return MOCK.filter(m => {
            ...
            if (filters.skills.length > 0 && !filters.skills.some(s => m.skills.includes(s)))
                return false;

            if (filters.gender !== 'All' && m.gender !== filters.gender.toLowerCase())
                return false;

            if (filters.branch !== 'All' && m.branch !== filters.branch)
                return false;

            if (filters.year !== 'All' && m.year !== yearNumMap[filters.year])
                return false;

            if (filters.availableOnly && !m.available)
                return false;
      ...
      `}</style>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                {view === 'list' && (<>
                    ...
                    {/* ── Page header ── */}
                    <div className="tf-fadein" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
                        <div>
                        ...
                        >
                            ...
                            {activeFilterCount > 0 && (
                                <span style={{
                                    width: 18, height: 18, borderRadius: '50%',
                                    background: B.dark, color: '#fff',
                                    fontSize: '0.68rem', fontWeight: 800, fontFamily: FONT,
                                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                                }}>
                                    {activeFilterCount}
                                </span>
                    ...
                    <div className="tf-fadein" style={{
                        ...
                        <input
                            ...
                            style={{
                                border: 'none', outline: 'none', background: 'transparent',
                                fontSize: '0.9rem', color: B.dark, fontFamily: FONT, flex: 1,
                            }}
                        />
                        {filters.search && (
                            <button
                                onClick={() => setFilters(p => ({ ...p, search: '' }))}
                                style={{ background: 'none', border: 'none', cursor: 'pointer', color: B.muted, display: 'flex', padding: 0 }}
                            >
                                <X size={16} />
                            </button>
                        )}
                            ...
                            {results.length === 0 ? (
                                ...
                                <>
                                    <p style={{
                                        ...
                                        marginBottom: '0.85rem', fontWeight: 600,
                                    }}>
